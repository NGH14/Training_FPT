...
namespace FPT.Data.Migrations
{
    ...
    [Migration("20210911022938_updata-database2")]
    partial class updatadatabase2
    {
            ...
            modelBuilder.Entity("FPT.Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "7acb76e8-1a8a-46ef-8e39-359d865cc0e0",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "592396c6-7795-47e3-9461-b7caaa07579f",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "b602dee8-2ea0-42b5-80ea-b66320cb1429",
            ...
            modelBuilder.Entity("FPT.Data.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "21e3f4f7-ce06-481d-b8d8-1816e52858ed",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEGeZdA6/3y4xTpVc23dt2jBY/aJ/lwuaB8M5e7D62GLTRtmkaCHHMCVzy2f503JpSg==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "f0e1e784-347f-41e6-9d6a-44362f628677",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAENB4BcPRr0KtMugh4D2ZjepRHxxRvlv3F1cKbSEo867ddehBS66va0kSYMqj31Pfdw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "",
                            TwoFactorEnabled = false,
                            UserName = "Nghiavuhuu"
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "7ffbcf11-da18-405b-941d-19095fb60805",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEO2k8ivDKzUq2jysz1TFLSqPsgR4w+Z8lcTpEsFix51kwLgruq3zwyc4MFAYQBO7NA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "",
                            TwoFactorEnabled = false,
                            UserName = "NhanVan"
            ...
            modelBuilder.Entity("FPT.Data.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2021, 9, 11, 9, 29, 37, 607, DateTimeKind.Local).AddTicks(8923)
                        },
                        new
                        {
                            Id = 2,
                            DateCreated = new DateTime(2021, 9, 11, 9, 29, 37, 609, DateTimeKind.Local).AddTicks(7238)
                        },
                        new
                        {
                            Id = 3,
                            DateCreated = new DateTime(2021, 9, 11, 9, 29, 37, 609, DateTimeKind.Local).AddTicks(7382)
                        },
                        new
                        {
                            Id = 4,
                            DateCreated = new DateTime(2021, 9, 11, 9, 29, 37, 609, DateTimeKind.Local).AddTicks(7424)
                        },
                        new
                        {
                            Id = 5,
                            DateCreated = new DateTime(2021, 9, 11, 9, 29, 37, 609, DateTimeKind.Local).AddTicks(7459)
                        },
                        new
                        {
                            Id = 6,
                            DateCreated = new DateTime(2021, 9, 11, 9, 29, 37, 609, DateTimeKind.Local).AddTicks(7502)
                        },
                        new
                        {
                            Id = 7,
                            DateCreated = new DateTime(2021, 9, 11, 9, 29, 37, 609, DateTimeKind.Local).AddTicks(7537)
                        },
                        new
                        {
                            Id = 8,
                            DateCreated = new DateTime(2021, 9, 11, 9, 29, 37, 609, DateTimeKind.Local).AddTicks(7574)
                        },
                        new
                        {
                            Id = 9,
                            DateCreated = new DateTime(2021, 9, 11, 9, 29, 37, 609, DateTimeKind.Local).AddTicks(7612)
                        },
                        new
                        {
                            Id = 10,
                            DateCreated = new DateTime(2021, 9, 11, 9, 29, 37, 609, DateTimeKind.Local).AddTicks(7650)
                        });
                });
            ...
            modelBuilder.Entity("FPT.Data.Entities.ProductTranslation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            End = new DateTime(2021, 11, 30, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            LanguageId = "vi",
                            Name = "Tập trung vào mục tiêu",
                            ProductId = 1,
                            Start = new DateTime(2021, 9, 30, 0, 0, 0, 0, DateTimeKind.Unspecified),
